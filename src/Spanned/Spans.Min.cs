...
public static partial class Spans
{
    ...
    public static byte Min(this scoped Span<byte> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);

    /// <inheritdoc cref="Min(Span{byte})"/>
    public static byte Min(this scoped ReadOnlySpan<byte> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);
    ...
    /// <inheritdoc cref="Min(Span{byte})"/>
    [CLSCompliant(false)]
    public static sbyte Min(this scoped Span<sbyte> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);

    /// <inheritdoc cref="Min(Span{sbyte})"/>
    [CLSCompliant(false)]
    public static sbyte Min(this scoped ReadOnlySpan<sbyte> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);
    ...
    /// <inheritdoc cref="Min(Span{byte})"/>
    public static short Min(this scoped Span<short> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);

    /// <inheritdoc cref="Min(Span{short})"/>
    public static short Min(this scoped ReadOnlySpan<short> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);
    ...
    /// <inheritdoc cref="Min(Span{byte})"/>
    [CLSCompliant(false)]
    public static ushort Min(this scoped Span<ushort> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);

    /// <inheritdoc cref="Min(Span{ushort})"/>
    [CLSCompliant(false)]
    public static ushort Min(this scoped ReadOnlySpan<ushort> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);
    ...
    /// <inheritdoc cref="Min(Span{byte})"/>
    public static int Min(this scoped Span<int> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);

    /// <inheritdoc cref="Min(Span{int})"/>
    public static int Min(this scoped ReadOnlySpan<int> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);
    ...
    /// <inheritdoc cref="Min(Span{byte})"/>
    [CLSCompliant(false)]
    public static uint Min(this scoped Span<uint> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);

    /// <inheritdoc cref="Min(Span{uint})"/>
    [CLSCompliant(false)]
    public static uint Min(this scoped ReadOnlySpan<uint> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);
    ...
    /// <inheritdoc cref="Min(Span{byte})"/>
    public static long Min(this scoped Span<long> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);

    /// <inheritdoc cref="Min(Span{long})"/>
    public static long Min(this scoped ReadOnlySpan<long> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);
    ...
    /// <inheritdoc cref="Min(Span{byte})"/>
    [CLSCompliant(false)]
    public static ulong Min(this scoped Span<ulong> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);

    /// <inheritdoc cref="Min(Span{ulong})"/>
    [CLSCompliant(false)]
    public static ulong Min(this scoped ReadOnlySpan<ulong> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);
    ...
    /// <returns>The minimum value in the span.</returns>
    /// <exception cref="InvalidOperationException"><paramref name="span"/> contains no elements.</exception>
    public static float UnsafeMin(this scoped Span<float> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);

    /// <inheritdoc cref="UnsafeMin(Span{float})"/>
    public static float UnsafeMin(this scoped ReadOnlySpan<float> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);
    ...
    /// <param name="span">A span of <see cref="double"/> values to determine the minimum value of.</param>
    /// <inheritdoc cref="UnsafeMin(Span{float})"/>
    public static double UnsafeMin(this scoped Span<double> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);

    /// <inheritdoc cref="UnsafeMin(Span{double})"/>
    public static double UnsafeMin(this scoped ReadOnlySpan<double> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);
    ...
    /// <returns>The minimum value in the span.</returns>
    /// <exception cref="InvalidOperationException"><paramref name="span"/> contains no elements.</exception>
    public static T? UnsafeMin<T>(this scoped Span<T> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);

    /// <inheritdoc cref="UnsafeMin{T}(Span{T})"/>
    public static T? UnsafeMin<T>(this scoped ReadOnlySpan<T> span) => Min(ref MemoryMarshal.GetReference(span), span.Length, comparer: null);
}
