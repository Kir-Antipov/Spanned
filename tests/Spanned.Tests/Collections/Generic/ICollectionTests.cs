...
/// </summary>
public abstract class ICollectionTests<T> : IEnumerableTests<T>
{
    /// <summary>
    ...
    protected virtual Type ICollection_CopyTo_IndexLargerThanArrayCount_ThrowType => typeof(ArgumentOutOfRangeException);
    ...
    public void ICollection_IsReadOnly_Validity(int count)
    {
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Count_Validity(int count)
    {
        ICollection<T> collection = GenericICollectionFactory(count);
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public virtual void ICollection_Add_DefaultValue(int count)
    {
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Add_InvalidValueToMiddleOfCollection(int count)
    {
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Add_InvalidValueToBeginningOfCollection(int count)
    {
        if (!IsReadOnly && !AddRemoveClear_ThrowsNotSupported)
        {
            Assert.All(InvalidValues, invalidValue =>
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Add_InvalidValueToEndOfCollection(int count)
    {
        if (!IsReadOnly && !AddRemoveClear_ThrowsNotSupported)
        {
            Assert.All(InvalidValues, invalidValue =>
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Add_DuplicateValue(int count)
    {
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Add_AfterCallingClear(int count)
    {
        if (!IsReadOnly && !AddRemoveClear_ThrowsNotSupported)
        {
            ICollection<T> collection = GenericICollectionFactory(count);
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Add_AfterRemovingAnyValue(int count)
    {
        if (!IsReadOnly && !AddRemoveClear_ThrowsNotSupported)
        {
            int seed = 840;
            ...
            collection.Add(toAdd);
            items.Add(toAdd);
            EqualUnordered(items, collection);
        }
    }

    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Add_AfterRemovingAllItems(int count)
    {
        if (!IsReadOnly && !AddRemoveClear_ThrowsNotSupported)
        {
            ICollection<T> collection = GenericICollectionFactory(count);
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Add_ToReadOnlyCollection(int count)
    {
        if (IsReadOnly || AddRemoveClear_ThrowsNotSupported)
        {
            ICollection<T> collection = GenericICollectionFactory(count);
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Add_AfterRemoving(int count)
    {
        if (!IsReadOnly && !AddRemoveClear_ThrowsNotSupported)
        {
            int seed = 840;
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Clear(int count)
    {
        ICollection<T> collection = GenericICollectionFactory(count);
        if (IsReadOnly || AddRemoveClear_ThrowsNotSupported)
        {
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Clear_Repeatedly(int count)
    {
        ICollection<T> collection = GenericICollectionFactory(count);
        if (IsReadOnly || AddRemoveClear_ThrowsNotSupported)
        {
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Contains_ValidValueOnCollectionNotContainingThatValue(int count)
    {
        ICollection<T> collection = GenericICollectionFactory(count);
        int seed = 4315;
        T item = CreateT(seed++);
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Contains_ValidValueOnCollectionContainingThatValue(int count)
    {
        ICollection<T> collection = GenericICollectionFactory(count);
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Contains_DefaultValueOnCollectionNotContainingDefaultValue(int count)
    {
        ICollection<T> collection = GenericICollectionFactory(count);
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public virtual void ICollection_Contains_DefaultValueOnCollectionContainingDefaultValue(int count)
    {
        if (DefaultValueAllowed && !IsReadOnly && !AddRemoveClear_ThrowsNotSupported)
        {
            ICollection<T> collection = GenericICollectionFactory(count);
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Contains_ValidValueThatExistsTwiceInTheCollection(int count)
    {
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Contains_InvalidValue_ThrowsArgumentException(int count)
    {
        ICollection<T> collection = GenericICollectionFactory(count);
        Assert.All(InvalidValues, invalidValue =>
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Contains_DefaultValueWhenNotAllowed(int count)
    {
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_CopyTo_NullArray_ThrowsArgumentNullException(int count)
    {
        ICollection<T> collection = GenericICollectionFactory(count);
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_CopyTo_NegativeIndex_ThrowsArgumentOutOfRangeException(int count)
    {
        ICollection<T> collection = GenericICollectionFactory(count);
        T[] array = new T[count];
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_CopyTo_IndexEqualToArrayCount_ThrowsArgumentException(int count)
    {
        ICollection<T> collection = GenericICollectionFactory(count);
        T[] array = new T[count];
        if (count > 0)
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_CopyTo_IndexLargerThanArrayCount_ThrowsAnyArgumentException(int count)
    {
        ICollection<T> collection = GenericICollectionFactory(count);
        T[] array = new T[count];
        Assert.Throws(ICollection_CopyTo_IndexLargerThanArrayCount_ThrowType, () => collection.CopyTo(array, count + 1));
    }

    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_CopyTo_NotEnoughSpaceInOffsettedArray_ThrowsArgumentException(int count)
    {
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_CopyTo_ExactlyEnoughSpaceInArray(int count)
    {
        ICollection<T> collection = GenericICollectionFactory(count);
        T[] array = new T[count];
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_CopyTo_ArrayIsLargerThanCollection(int count)
    {
        ICollection<T> collection = GenericICollectionFactory(count);
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Remove_OnReadOnlyCollection_ThrowsNotSupportedException(int count)
    {
        if (IsReadOnly || AddRemoveClear_ThrowsNotSupported)
        {
            ICollection<T> collection = GenericICollectionFactory(count);
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Remove_DefaultValueNotContainedInCollection(int count)
    {
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Remove_NonDefaultValueNotContainedInCollection(int count)
    {
        if (!IsReadOnly && !AddRemoveClear_ThrowsNotSupported)
        {
            int seed = count * 251;
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public virtual void ICollection_Remove_DefaultValueContainedInCollection(int count)
    {
        if (!IsReadOnly && !AddRemoveClear_ThrowsNotSupported && DefaultValueAllowed && !Enumerable.Contains(InvalidValues, default!))
        {
            ICollection<T> collection = GenericICollectionFactory(count);
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Remove_NonDefaultValueContainedInCollection(int count)
    {
        if (!IsReadOnly && !AddRemoveClear_ThrowsNotSupported)
        {
            int seed = count * 251;
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Remove_ValueThatExistsTwiceInCollection(int count)
    {
        if (!IsReadOnly && !AddRemoveClear_ThrowsNotSupported && DuplicateValuesAllowed)
        {
            int seed = count * 90;
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Remove_EveryValue(int count)
    {
        if (!IsReadOnly && !AddRemoveClear_ThrowsNotSupported)
        {
            ICollection<T> collection = GenericICollectionFactory(count);
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Remove_InvalidValue_ThrowsArgumentException(int count)
    {
        ICollection<T> collection = GenericICollectionFactory(count);
    ...
    [Theory]
    [MemberData(nameof(ValidCollectionSizes))]
    public void ICollection_Remove_DefaultValueWhenNotAllowed(int count)
    {
        if (!DefaultValueAllowed && !IsReadOnly && !AddRemoveClear_ThrowsNotSupported)
        {
            ICollection<T> collection = GenericICollectionFactory(count);
